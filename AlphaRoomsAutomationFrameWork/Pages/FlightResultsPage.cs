...
namespace AlphaRooms.AutomationFramework
{
    public static class FlightResultsPage
    {
        ...
        {
            return Driver.Instance.IsElementDisplayedById("flightresultspage");
        }

        private static ReadOnlyCollection<IWebElement> GetFlightResultPanels()
        {
            IWebElement searchResults = Driver.Instance.FindElement(By.CssSelector("div.section ul.list.results"));
            return searchResults.FindElements(By.CssSelector("li.list-item.card"));
        }

        private static IWebElement GetFlightPanel(int flightNumber)
        {
            return GetFlightResultPanels()[flightNumber - 1];//.FindElement(By.CssSelector("div.flight-listing"));
        }

        private static IWebElement GetAvailableFlightButton(int flightNumber)
        {
            IWebElement fullpriceinformation = GetFlightPanel(flightNumber).FindElement(By.CssSelector("div.flight-overview"));
            return fullpriceinformation.FindElement(By.CssSelector("div div.flight-result-select form"));
        }
        ...
        private static void SaveFlightData(int flightNumber)
        {
            ...
            var fullflightinformation = fullresult.FindElement(By.CssSelector("div.flight-legs"));

            IWebElement outBoundFlightInfo = fullflightinformation.FindElement(By.CssSelector("div.outbound-flight-leg"));
            IWebElement inBoundFlightInfo = fullflightinformation.FindElement(By.CssSelector("div.inbound-flight-leg"));

            FlightResultsPage.Data.OutboundAirline = outBoundFlightInfo.FindElement(By.TagName("img")).GetAttribute("alt");

            IWebElement fullOutBoundDepartureFlightInfo = outBoundFlightInfo.FindElement(By.CssSelector("div.flight-leg div.flight-leg-departure"));

            IWebElement outBoundDepartureAiport = fullOutBoundDepartureFlightInfo.FindElement(By.CssSelector("div.flight-leg-airport"));
            FlightResultsPage.Data.OutboundDepartureAirport = outBoundDepartureAiport.Text;

            IWebElement outBoundDepartureFlightTime = fullOutBoundDepartureFlightInfo.FindElement(By.CssSelector("em.flight-leg-departure-time"));
            FlightResultsPage.Data.OutboundDepartureTime = outBoundDepartureFlightTime.Text;
            IWebElement outBoundFlightNumber = fullOutBoundDepartureFlightInfo.FindElement(By.CssSelector("div.flight-number"));
            FlightResultsPage.Data.OutboundFlightNo = outBoundFlightNumber.Text;
            IWebElement outBoundFlightType = fullOutBoundDepartureFlightInfo.FindElement(By.CssSelector("span"));
            FlightResultsPage.Data.OutboundFlightType = outBoundFlightType.Text;
            IWebElement outBoundFlightTime = fullOutBoundDepartureFlightInfo.FindElement(By.CssSelector("span.flight-leg-total-duration"));
            //Fix this later on
            FlightResultsPage.Data.OutboundJourneyTime = string.Concat(outBoundFlightTime.Text.Remove(0, 2));


            IWebElement fullOutBoundArrivalFlightInfo = outBoundFlightInfo.FindElement(By.CssSelector("div.flight-leg div.flight-leg-arrival"));

            IWebElement outBoundArrivalAiport = fullOutBoundArrivalFlightInfo.FindElement(By.CssSelector("div.flight-leg-airport"));
            FlightResultsPage.Data.OutboundArrivalAirport = outBoundArrivalAiport.Text;
            IWebElement outBoundArrivalFlightTime = fullOutBoundArrivalFlightInfo.FindElement(By.CssSelector("em.flight-leg-departure-time"));
            FlightResultsPage.Data.OutboundArrivalTime = string.Concat(outBoundArrivalFlightTime.Text);
            ...
            IWebElement fullInBoundDepartureFlightInfo = inBoundFlightInfo.FindElement(By.CssSelector("div.flight-leg-departure.flight-leg-inbound-departure"));

            IWebElement inBoundDepartureAiport = fullInBoundDepartureFlightInfo.FindElement(By.CssSelector("div.flight-leg-airport"));
            FlightResultsPage.Data.InboundDepartureAirport = inBoundDepartureAiport.Text;
            IWebElement inBoundDepartureFlightTime = fullInBoundDepartureFlightInfo.FindElement(By.CssSelector("em.flight-leg-departure-time"));
            FlightResultsPage.Data.InboundDepartureTime = inBoundDepartureFlightTime.Text; // string.Concat(inBoundDepartureFlightTime.Text.Remove(0, 6), " ", inBoundDepartureFlightTime.Text.Remove(5));
            IWebElement inBoundFlightNumber = fullInBoundDepartureFlightInfo.FindElement(By.CssSelector("div.flight-number"));
            FlightResultsPage.Data.InboundFlightNo = inBoundFlightNumber.Text;

            IWebElement fullInBoundArrivalFlightInfo = inBoundFlightInfo.FindElement(By.CssSelector("div.flight-leg div.flight-leg-arrival"));

            IWebElement inBoundArrivalAiport = fullInBoundArrivalFlightInfo.FindElement(By.CssSelector("div.flight-leg-airport"));
            FlightResultsPage.Data.InboundArrivalAirport = inBoundArrivalAiport.Text;
            IWebElement inBoundArrivalFlightTime = fullInBoundArrivalFlightInfo.FindElement(By.CssSelector("em.flight-leg-departure-time"));
            FlightResultsPage.Data.InboundArrivalTime = inBoundArrivalFlightTime.Text; // string.Concat(inBoundArrivalFlightTime.Text.Remove(0, 6), " ", inBoundArrivalFlightTime.Text.Remove(5));
            IWebElement inBoundFlightType = fullInBoundDepartureFlightInfo.FindElement(By.CssSelector("span"));
            ...
            //IWebElement inBoundFlightStops = fullInBoundArrivalFlightInfo.FindElement(By.CssSelector("span"));
            //FlightResultsPage.Data.InboundJourney = inBoundFlightStops.Text;
            IWebElement inBoundFlightTime = fullInBoundArrivalFlightInfo.FindElement(By.CssSelector("em.flight-leg-departure-time"));
            FlightResultsPage.Data.InboundJourneyTime = string.Concat(inBoundFlightTime.Text);

            var fullpriceinformation = fullresult.FindElement(By.CssSelector("div.flight-overview"));

            IWebElement flightPrice = fullpriceinformation.FindElement(By.CssSelector("div.price-container em.price.flight-overview-price"));
