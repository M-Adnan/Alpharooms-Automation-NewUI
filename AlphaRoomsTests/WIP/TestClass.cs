...
namespace AlphaRooms.AutomationFramework.Tests.WIP
{
    ...
    //        Assert.That(ExtrasPage.IsDisplayed(), "Extras Page not showing");

    //        ExtrasPage.Save(Information.Hotel);

    //        Assert.That(HotelResultsPage.Data.HotelName == ExtrasPage.Data.HotelName, "Differing hotel names from SR to Extras");
    ...
    //        Assert.That(PaymentPage.IsDisplayed(), "Payment page not displaying");

    //        PaymentPage.Save(Information.Hotel);

    //        Assert.That(ExtrasPage.Data.HotelName == PaymentPage.Data.HotelName, "Hotel name differs from Extras to Payment");
