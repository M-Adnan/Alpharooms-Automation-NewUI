...
namespace AlphaRooms.AutomationFramework.Tests.Smoke_Tests
{
    ...
    public class FlightAndHotelBookingTests : AlpharoomsTestBase
    {
        ...
        public void ShouldMakeFlightAndHotelBooking()
        {
            ...
            Assert.That(FlightResultsPage.AreResultsDisplayed(), "No results are displayed");
...
//            //check if result page is displayed
//            Assert.That(FlightResultsPage.IsDisplayed(), "Search Result Page isn't displayed");
...
//            //confirm information
//            Assert.That(ExtrasPage.Confirm(Information.FlightAndHotel), "Selected flightAndHotel information doesn't match with flight information on Extras page");
...
//            //confirm information
//            Assert.That(PaymentPage.Confirm(Information.FlightAndHotel), "Selected flight information doesn't match with flight information on Extras page");
