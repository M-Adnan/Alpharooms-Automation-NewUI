...
namespace AlphaRooms.AutomationFramework.Tests.Smoke_Tests
{
    ...
    public class FlightOnlyBookingTests : AlpharoomsTestBase
    {
        ...
        //    //ExtrasPage.Data.
        //    ExtrasPage.Save(Information.Flight);
        //    Assert.That(ExtrasPage.Save(Information.Flight), "Selected flight information doesn't match with flight information on Extras page");
        //    //Match flight information
        //    Assert.That(ExtrasPage.Confirm(Information.Flight), "Selected flight information doesn't match with flight information on Extras page");
        //    ////Extras Page Save Flight Info
        //    ////ExtrasPage.Data.
        //    //ExtrasPage.Save(Information.Flight);
        ...
        //    //Assert.That(PaymentPage.Confirm(Information.Flight), "Selected flight information doesn't match with flight information on Payment page");
