...
namespace AlphaRooms.AutomationFramework.Processes.Home
{
    public class SearchFlightOnly : ISearchFlightOnly, ISearchFlightOnlyChildren
    {
        ...
        private bool FlightSearchType;

        public SearchFlightOnly()
        {
            FlightSearchType = true;
        }
        ...
        private void SearchProcess()
        {
            ...
            if ((deptAirport != null) && (FlightSearchType = false)) HomePage.SelectAirport(deptAirport);
            if ((deptAirport != null) && (FlightSearchType = true)) HomePage.SelectAirportFlightOnly(deptAirport);
