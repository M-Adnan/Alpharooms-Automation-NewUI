...
namespace AlphaRooms.AutomationFramework
{
    public static class HomePage
    {
        ...
        {
            return Driver.Instance.FindElement(By.CssSelector("li.control-group.control-group-search.control-group-search-search button.btn"));
        }

        private static ReadOnlyCollection<IWebElement> GetSearchOptionsButtons()
        {
            return Driver.Instance.FindElementsWithTimeout(By.CssSelector("form#searchFormForm.search-form ul.list.list-search-type li"), 0);
        }
        ...
        public static void ClickFlightOnly()
        {
            ...
            searchOptions[2].FindElement(By.CssSelector("label.label-search-type.ctx-flight")).Click();
        ...
        public static void ClickHotelOnly()
        {
            ...
            var searchOptions = GetSearchOptionsButtons();
            searchOptions[1].FindElement(By.CssSelector("label.label-search-type.ctx-hotel")).Click();
        ...
        public static void ClickFlightAndHotel()
        {
            ...
            var searchOptions = GetSearchOptionsButtons();
            searchOptions[0].FindElement(By.CssSelector("label.label-search-type.ctx-holiday")).Click();
        ...
        public static void SelectCheckIn(string checkIn)
        {
            ...
            //Logger.AddSelectAction("CheckIn", checkIn);
            WebControls.SelectDateBox("fromDate", "/html/body/div[2]", checkIn);
        ...
        public static void SelectCheckOut(string checkOut)
        {
            ...
            WebControls.SelectDateBox("toDate", "/html/body/div[3]", checkOut);
        ...
        public static void SelectAirport(string deptAirport)
        {
            ...
            var dropdownDepartureAirport = Driver.Instance.FindElement(By.Id("departureAirportName"));
