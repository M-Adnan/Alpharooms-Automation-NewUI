...
namespace AlphaRooms.AutomationFramework
{
    public static class HotelDetailPage
    {
        ...
        {
            var tabContent = Driver.Instance.FindElement(By.CssSelector("div.rooms-wrapper"));
            ReadOnlyCollection<IWebElement> rooms = tabContent.FindElements(By.CssSelector("ul.list.rooms-list.card li"));
        ...
        private static IWebElement GetAvailableRoomButton(int availableRoom)
        {
            ...
            return roomTr.FindElement(By.CssSelector("div.select-room-wrapper a"));
        }
        ...
        {
            var hotelDiv = Driver.Instance.FindElement(By.ClassName("establishment-page-head"));
            //string[] hotelDetailsArray = hotelDiv.Text.Split(new string[] { "\r\n" }, StringSplitOptions.None);
            //HotelResultsPage.Data.HotelNumber = hotelNumber;
            HotelDetailPage.Data.HotelName = hotelDiv.FindElement(By.CssSelector("div.establishment-header")).Text;
            HotelDetailPage.Data.HotelAddress = hotelDiv.FindElement(By.CssSelector("div.establishment-details address.establishment-address")).Text;
            HotelDetailPage.Data.HotelLocation = hotelDiv.FindElement(By.CssSelector("div.establishment-details span.establishment-destination")).Text;
